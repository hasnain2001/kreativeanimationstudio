...
@section('title')
3D Architectural Animation Services - Building Dreams in 3D
@endsection
@section('description')
Experience the future of architecture with AFX Animators' architectural 3D animation services. See your projects in a whole new dimension.
@endsection
...
@keyframes up-down {
 ...
 font-weight: 400;  
  ...
  <section id="hero" class="hero section dark-background">
    ...
    <div class=" col-md-5">
<h1>3D Architectural Animation Company Transforming Your Blueprints! </h1>
<p>We are an architectural 3D animation company that tailors each project to meet the unique needs of our clients, ensuring that every detail is captured with precision and creativity.</p>
...
<div class="container">
    <div class="row">
        <div class=" col-md-6 ">
<h2>3D Architectural Animation Studio for Luxury Real Estate Businesses</h2>
<p style="font-size: 14px;">Welcome to AFX, the top choice for premium 60-secondsvideo creation. Our focus is on developing compelling videos that attract your audience’s interest and make a lasting impact. Utilizing our animation and storytelling skills, we give life to your concepts and assist in conveying your message efficiently within a short period.
    ...
    <p style="font-size: 14px;">If you require an Animated Explainer Video, promotional video, or Whiteboard Animation Services, our committed team will collaborate with you during the production to bring your vision to life. We assure you that your target audience will remember your 60-secondsvideo due to our focus on detail, creativity, and technical skills.</p>
     ...
     <img src="{{asset('images/3d-architectural-animation/gif-1.gif')}}" alt="image" srcset="" class=" img-fluid"  >
        </div>
    </div>
...
<section id="gallery" class="gallery section">
    ...
    <h2 class=" card-title">Our Portfolio of Stunning 3D Architectural Animations</h2>
    <p>Our Animation Services breathe life into architectural designs with impressive realism and detail, covering both residential and commercial buildings as well as intricate interior and exterior visualizations.</p>
    </div>
...
<section style="background-color: #dedede; padding: 20px;">
    <div class="container" style="display: flex; align-items: center; justify-content: space-between;">
        <div>
            <span style="font-size: 1.5em; font-weight: bold;">Don't Miss Out on Stunning 3D Animations</span>
            <p>Start Your 3D Animation Project Today!</p>
        </div>
...
<section style="background: linear-gradient(to bottom,#ffffff, #fdfdfd); color: rgb(0, 0, 0);">
    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-md-6">
                <h1>How Can Your Business Benefit From 3D Architecture Animation Creator?</h1>
...
<p style="font-size: 12px;">They provide a visually captivating method to simplify complex ideas, display products, and encourage customer engagement. Businesses can enhance their communication efficiency, improve conversions, and differentiate themselves in a competitive digital environment by summarizing important information in a user-friendly manner.</p>
            ...
            <div class=" col-md-6 ">
                <img src="{{asset('images/3d-architectural-animation/gif-2.gif')}}" alt="" srcset="" height="300" width="100%"  >
    ...
    <div class="row">
        <div class=" col-md-6 ">
            <img src="{{asset('images/3d-architectural-animation/gif-3.gif')}}" alt="" class="" height="400" width="100%">
        
            </div>
    <div class="col-md-6">
    <h3>Here's What Sets Us Apart As 3D Architecture Animators!</h3>
    ...
    <a href="{{route('contact')}}" class="btn btn-custom">Get Started</a>
        ...
        <section style="background-color:#; color:rgb(0, 0, 0);" >
    <div class="container">
    <!-- Header Section -->
    <div class="header-2d">Our 3D Architectural Animation Services</div>
    ...
    <h4>Residential and Commercial Buildings</h4>
    <p>
    ...
    <div class="col-md-6 mb-4">
    <h4>Interior and Exterior Visualizations</h4>
    <p>
    ...
    <div class="col-md-6 mb-4">
    <h4>Urban Planning and Landscape Design</h4>
    <p>
    ...
    <img src="{{asset('images/3d-architectural-animation/gif-4.gif')}}" alt="Illustration" class="illustration">
    </div>
    </div>
    </div>
