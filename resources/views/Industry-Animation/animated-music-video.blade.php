...
@keyframes up-down {
 ...
 font-weight: 400;  
  ...
  .header-2d {
    ...
    .section-1{
    background-color:#fe7878; /* Fallback color */
    color:rgb(0, 0, 0);
  ...
  <section id="hero" class="hero section dark-background">
    ...
    <div class=" col-md-5">
<h1>Animated Music Video Company Turning Songs into Visual Masterpieces!</h1>
<p>Turn your songs into unforgettable stunning music videos with AFX Animators’ custom-animated music video services!</p>
...
<div class="container">
    <div class="row">
        <div class=" col-md-6 ">
<h2>AFX Animated Music Video Makers Capture Your Music's Soul! </h2>
<p style="font-size: 14px;">Welcome to AFX, the top choice for premium 60-secondsvideo creation. Our focus is on developing compelling videos that attract your audience’s interest and make a lasting impact. Utilizing our animation and storytelling skills, we give life to your concepts and assist in conveying your message efficiently within a short period.
    ...
    <p style="font-size: 14px;">If you require an Animated Explainer Video, promotional video, or Whiteboard Animation Services, our committed team will collaborate with you during the production to bring your vision to life. We assure you that your target audience will remember your 60-secondsvideo due to our focus on detail, creativity, and technical skills.</p>
     ...
     <img src="{{asset('images/animated-music-video/gif-1.gif')}}" alt="image" srcset="" class=" img-fluid"  >
        </div>
    </div>
...
<section id="gallery" class="gallery section">
    ...
    <div class="container " data-aos="fade-up">
        <div class=" text-center">
            <h2 class=" card-title">AFX Music Video Masterpieces</h2>
            <p>From vibrant lyric videos to captivating character animations, our work showcases creativity and technical expertise.</p>
        </div>
...
<section style="background-color: #dedede; padding: 20px;">
    <div class="container" style="display: flex; align-items: center; justify-content: space-between;">
        <div>
            <span style="font-size: 1.5em; font-weight: bold;">Don't Just Play Your Music, Show It!</span>
            <p>Let Us Create Your Animated Music Video.</p>
        </div>
...
<section style="background: linear-gradient(to bottom,#f8ae38, #f8ae38); color: rgb(0, 0, 0);">
    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-md-6">
                <h1>Why Does Your Music Need An Animated Music Video Studio?</h1>
...
<p style="font-size: 12px;">They provide a visually captivating method to simplify complex ideas, display products, and encourage customer engagement. Businesses can enhance their communication efficiency, improve conversions, and differentiate themselves in a competitive digital environment by summarizing important information in a user-friendly manner.</p>
            ...
            <div class=" col-md-6 ">
                <img src="{{asset('images/animated-music-video/gif-2.gif')}}" alt="" srcset="" height="300" width="100%"  >
    ...
    <section style="background-color:#5c55b4; color:rgb(0, 0, 0);">
    <div class="container ">
    <div class="row">
        <div class=" col-md-6 ">
            <img src="{{asset('images/animated-music-video/gif-3.gif')}}" alt="" class="" height="400" width="100%">
        
            </div>
    <div class="col-md-6">
    <h3>Why Choose AFX Animators for Your Animated Music Video Needs?</h3>
    ...
    <div class="container">
    <!-- Header Section -->
    <div class="header-2d">Our Animated Music Video Services For Stunning Visuals!</div>
    ...
    <h4>Custom Animated Music Videos</h4>
    <p>
    ...
    <img src="{{asset('images/animated-music-video/gif-4.gif')}}" alt="Illustration" class="illustration">
    </div>
    </div>
    </div>
