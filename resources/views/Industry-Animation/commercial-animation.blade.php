...
@section('title')
Commercial Animation Service - Crafting Stories in Motion
@endsection
@section('description')
Transform your brand's message with AFX Animators' animated commercial services. Engage your audience with dynamic and impactful animations.
@endsection
...
@keyframes up-down {
 ...
 font-weight: 400;  
  ...
  .header-2d {
    ...
    .section-1{
    background-color:#90f2d7; /* Fallback color */
    color:rgb(0, 0, 0);
  ...
  <section id="hero" class="hero section dark-background">
    ...
    <div class=" col-md-5">
<h1>Commercial Animation Company Making Your Brand EXPLODE With Goodness! </h1>
<p>You need a commercial that grabs viewers by the eyeballs and holds them captive. That’s where AFX Animators comes in with animated commercial production services!</p>
...
<div class="container">
    <div class="row">
        <div class=" col-md-6 ">
<h2>Craft the Perfect Commercial With Our Commercial Animation Studio</h2>
<p style="font-size: 14px;">Welcome to AFX, the top choice for premium 60-secondsvideo creation. Our focus is on developing compelling videos that attract your audience’s interest and make a lasting impact. Utilizing our animation and storytelling skills, we give life to your concepts and assist in conveying your message efficiently within a short period.
    ...
    <p style="font-size: 14px;">If you require an Animated Explainer Video, promotional video, or Whiteboard Animation Services, our committed team will collaborate with you during the production to bring your vision to life. We assure you that your target audience will remember your 60-secondsvideo due to our focus on detail, creativity, and technical skills.</p>
     ...
     <img src="{{asset('images/commercial-animation/gif-1.gif')}}" alt="image" srcset="" class=" img-fluid"  >
        </div>
    </div>
...
<section id="gallery" class="gallery section">
    ...
    <h2 class=" card-title">The Proof Of Excellence is in the Animation</h2>
    <p>Discover our outstanding collection of commercial 2D and 3D animation projects that display our innovation, skill, and dedication to excellence in visual storytelling.</p>
    </div>
...
<section style="background-color: #dedede; padding: 20px;">
    <div class="container" style="display: flex; align-items: center; justify-content: space-between;">
        <div>
            <span style="font-size: 1.5em; font-weight: bold;">Drive Engagement with Animation!</span>
            <p>Start creating memorable experiences.</p>
        </div>
...
<section style="background: linear-gradient(to bottom,#c1a3ff, #c1a3ff); color: rgb(0, 0, 0);">
    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-md-6">
                <h1>Why Does Your Brand Need An Animated Commercial Maker?</h1>
...
<p style="font-size: 12px;">They provide a visually captivating method to simplify complex ideas, display products, and encourage customer engagement. Businesses can enhance their communication efficiency, improve conversions, and differentiate themselves in a competitive digital environment by summarizing important information in a user-friendly manner.</p>
            ...
            <div class=" col-md-6 ">
                <img src="{{asset('images/commercial-animation/gif-2.gif')}}" alt="" srcset="" height="300" width="100%"  >
    ...
    <section style="background-color:#ffd020; color:rgb(0, 0, 0);">
    <div class="container ">
    <div class="row">
        <div class=" col-md-6 ">
            <img src="{{asset('images/commercial-animation/gif-3.gif')}}" alt="" class="" height="400" width="100%">
        
            </div>
    <div class="col-md-6">
    <h3>Why Choose AFX Animators’ Commercial Animation Services?</h3>
    ...
    <a href="{{route('contact')}}" class="btn btn-custom">Get Started</a>
        ...
        <section style="background-color:#013470; color:rgb(255, 255, 255);" >
    <div class="container">
    <!-- Header Section -->
    <div class="header-2d">Explain Complex Products with Ease With Our Commercial Ad Services!</div>
    ...
    <div class="col-md-6 mb-4">
    <h4>3D Commercial Animations</h4>
    <p>
    ...
    <img src="{{asset('images/commercial-animation/gif-4.gif')}}" alt="Illustration" class="illustration">
    </div>
    </div>
    </div>
