...
@keyframes up-down {
 ...
 font-weight: 400;  
  ...
  .header-2d {
    ...
    .section-1{
    background-color:#569396; /* Fallback color */
  ...
  <section id="hero" class="hero section dark-background">
    ...
    <div class=" col-md-5">
<h1>Educational Animation Studio   Changing the Way You Learn!</h1>
<p>As leaders in the field, we are committed to transforming traditional learning methods with our innovative and compelling education animation services.</p>
...
<div class="container">
    <div class="row">
        <div class=" col-md-6 ">
<h2>Enjoy The Future of Learning With Animated Video Maker For Education </h2>
<p style="font-size: 14px;">Welcome to AFX, the top choice for premium 60-secondsvideo creation. Our focus is on developing compelling videos that attract your audience’s interest and make a lasting impact. Utilizing our animation and storytelling skills, we give life to your concepts and assist in conveying your message efficiently within a short period.
    ...
    <p style="font-size: 14px;">If you require an Animated Explainer Video, promotional video, or Whiteboard Animation Services, our committed team will collaborate with you during the production to bring your vision to life. We assure you that your target audience will remember your 60-secondsvideo due to our focus on detail, creativity, and technical skills.</p>
     ...
     <img src="{{asset('images/educational-animation/gif-1.gif')}}" alt="image" srcset="" class=" img-fluid"  >
        </div>
    </div>
...
<section id="gallery" class="gallery section">
    ...
    <div class="container " data-aos="fade-up">
        <div class=" text-center">
            <h2 class=" card-title">See How We've Transformed Learning!</h2>
            <p>Explore how AFX Animators enhances education through custom animation services, catering to a range of educational requirements, from K-12 educational videos to advanced e-learning modules.</p>
        </div>
...
<section style="background-color: #dedede; padding: 20px;">
    <div class="container" style="display: flex; align-items: center; justify-content: space-between;">
        <div>
            <span style="font-size: 1.5em; font-weight: bold;">Take Your Lessons to the Next Level</span>
            <p>See How Our Animations Can Enhance Your Teaching!</p>
        </div>
...
<section style="background: linear-gradient(to bottom,#c4d7c2, #e9ffe6); color: rgb(0, 0, 0);">
    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-md-6">
                <h1>Why Is Educational Animation Important?</h1>
...
<p style="font-size: 12px;">They provide a visually captivating method to simplify complex ideas, display products, and encourage customer engagement. Businesses can enhance their communication efficiency, improve conversions, and differentiate themselves in a competitive digital environment by summarizing important information in a user-friendly manner.</p>
            ...
            <div class=" col-md-6 ">
                <img src="{{asset('images/educational-animation/gif-2.gif')}}" alt="" srcset="" height="300" width="100%"  >
    ...
    <section style="background-color:#1481ba; color:rgb(0, 0, 0);">
    <div class="container ">
    <div class="row">
        <div class=" col-md-6 ">
            <img src="{{asset('images/educational-animation/gif-3.gif')}}" alt="" class="" height="400" width="100%">
        
            </div>
    <div class="col-md-6">
    <h3>Why Choose AFX Animators For Educational Animation?</h3>
    ...
    <div class="container">
    <!-- Header Section -->
    <div class="header-2d">A Look at Our Custom Educational Animation Services!</div>
    ...
    <div class="col-md-6 mb-4">
    <h4>Higher Education Animations</h4>
    <p>
    ...
    <img src="{{asset('images/educational-animation/gif-4.gif')}}" alt="Illustration" class="illustration">
    </div>
    </div>
    </div>
