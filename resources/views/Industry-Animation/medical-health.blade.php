...
@keyframes up-down {
 ...
 font-weight: 400;  
  ...
  <section id="hero" class="hero section dark-background">
    ...
    <div class=" col-md-5">
<h1>Medical Animation Company Changing the Face of Healthcare!</h1>
...
<div class="container">
    <div class="row">
        <div class=" col-md-6 ">
            <h2>Medical Animation Agency Backing You From Lab to Launch!</h2>
<p style="font-size: 14px;">Welcome to AFX, the top choice for premium 60-secondsvideo creation. Our focus is on developing compelling videos that attract your audience’s interest and make a lasting impact. Utilizing our animation and storytelling skills, we give life to your concepts and assist in conveying your message efficiently within a short period.
    ...
    <p style="font-size: 14px;">If you require an Animated Explainer Video, promotional video, or Whiteboard Animation Services, our committed team will collaborate with you during the production to bring your vision to life. We assure you that your target audience will remember your 60-secondsvideo due to our focus on detail, creativity, and technical skills.</p>
     ...
     <img src="{{asset('images/medical-health/gif-1.gif')}}" alt="image" srcset="" class=" img-fluid"  >
        </div>
    </div>
...
<section id="gallery" class="gallery section">
    ...
    <div class="container " data-aos="fade-up">
        <div class=" text-center">
            <h2 class=" card-title">Our Medical Animation Portfolio</h2>
            <p>The precision, creativity, and expertise of our 3D medical animation services are highlighted in our unique animations. Explore how visual storytelling in healthcare can be used for patient education and surgical procedures to make a positive impact.</p>
        </div>
...
<section style="background-color: #dedede; padding: 20px;">
    <div class="container" style="display: flex; align-items: center; justify-content: space-between;">
        <div>
            <span style="font-size: 1.5em; font-weight: bold;">Get Ahead in Healthcare</span>
            <p>Get Your Custom Animation Now!</p>
        </div>
...
<section style="background: linear-gradient(to bottom,#ffffff, #e0dcdc); color: rgb(0, 0, 0);">
    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-md-6">
                <h1>What Difference Do Medical Animation Firms Create?</h1>
...
<p style="font-size: 12px;">They provide a visually captivating method to simplify complex ideas, display products, and encourage customer engagement. Businesses can enhance their communication efficiency, improve conversions, and differentiate themselves in a competitive digital environment by summarizing important information in a user-friendly manner.</p>
            ...
            <div class=" col-md-6 ">
                <img src="{{asset('images/medical-health/gif-2.gif')}}" alt="" srcset="" height="300" width="100%"  >
    ...
    <section style="background-color:#4f2121; color:rgb(255, 255, 255);">
    <div class="container ">
    <div class="row">
        <div class=" col-md-6 ">
            <img src="{{asset('images/medical-health/gif-3.gif')}}" alt="" class="" height="400" width="100%">
        
            </div>
    <div class="col-md-6">
    <h3>Why AFX Animators Stand Out In Medical Animation Services?</h3>
    ...
    <a href="{{route('contact')}}" class="btn btn-custom">Get Started</a>
        ...
        <section style="background-color:white; color:rgb(0, 0, 0);" >
    <div class="container">
    <!-- Header Section -->
    <div class="header-2d">
        Our Range Of Medical Visualizations!
    </div>
    ...
    <h4>Mechanism Of Action (MOA) Animation </h4>
    <p>
    ...
    <div class="col-md-6 mb-4">
    <h4>Mechanism Of Disease (MOD) Animation</h4>
    <p>
    ...
    <div class="col-md-6 mb-4">
    <h4>Medical Device Animation</h4>
    <p>
    ...
    <img src="{{asset('images/medical-health/gif-4.gif')}}" alt="Illustration" class="illustration">
    </div>
    </div>
    </div>
