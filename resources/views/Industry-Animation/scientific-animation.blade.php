...
@keyframes up-down {
 ...
 font-weight: 400;  
  ...
  .header-2d {
    ...
    .section-1{
    background-color:#110f11; /* Fallback color */
  ...
  <section id="hero" class="hero section dark-background">
    ...
    <div class=" col-md-5">
<h1>Scientific Animation Company The Future of Science Communication!</h1>
<p>At AFX Animators, we specialize in delivering advanced scientific animation services tailored to meet the unique needs of researchers, educators, and organizations across the globe.</p>
...
<div class="container">
    <div class="row">
        <div class=" col-md-6 ">
            <h2>AFX Scientific Animation Agency For Seamless Scientific Animation Production</h2>
<p style="font-size: 14px;">Welcome to AFX, the top choice for premium 60-secondsvideo creation. Our focus is on developing compelling videos that attract your audience’s interest and make a lasting impact. Utilizing our animation and storytelling skills, we give life to your concepts and assist in conveying your message efficiently within a short period.
    ...
    <p style="font-size: 14px;">If you require an Animated Explainer Video, promotional video, or Whiteboard Animation Services, our committed team will collaborate with you during the production to bring your vision to life. We assure you that your target audience will remember your 60-secondsvideo due to our focus on detail, creativity, and technical skills.</p>
     ...
     <img src="{{asset('images/scientific-animation/gif-1.gif')}}" alt="image" srcset="" class=" img-fluid"  >
        </div>
    </div>
...
<section id="gallery" class="gallery section">
    ...
    <div class="container " data-aos="fade-up">
        <div class=" text-center">
            <h2 class=" card-title">See Science Come Alive In Our Portfolio</h2>
            <p>Take a look at our variety of scientific animation projects to see how AFX Animators has visually explained complex scientific ideas, providing clarity, interaction, and influence for researchers and companies globally.</p>
        </div>
...
<section style="background-color: #dedede; padding: 20px;">
    <div class="container" style="display: flex; align-items: center; justify-content: space-between;">
        <div>
            <span style="font-size: 1.5em; font-weight: bold;">Your Scientific Breakthrough Deserves the Best</span>
            <p>Request Your Free Animation Consultation!</p>
        </div>
...
<section style="background: linear-gradient(to bottom,#1d2235, #1c2444); color: rgb(255, 255, 255);">
    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-md-6">
                <h1>What Difference Does Scientific Animation Studio Create?</h1>
...
<p style="font-size: 12px;">They provide a visually captivating method to simplify complex ideas, display products, and encourage customer engagement. Businesses can enhance their communication efficiency, improve conversions, and differentiate themselves in a competitive digital environment by summarizing important information in a user-friendly manner.</p>
            ...
            <div class=" col-md-6 ">
                <img src="{{asset('images/scientific-animation/gif-2.gif')}}" alt="" srcset="" height="300" width="100%"  >
    ...
    <div class="row">
        <div class=" col-md-6 ">
            <img src="{{asset('images/scientific-animation/gif-3.gif')}}" alt="" class="" height="400" width="100%">
        
            </div>
    <div class="col-md-6">
    <h3>Why Choose AFX Animators for Your Scientific Animation Needs?</h3>
    ...
    <a href="{{route('contact')}}" class="btn btn-custom">Get Started</a>
        ...
        <section style="background-color:#bfbfbf; color:rgb(0, 0, 0);" >
    <div class="container">
    <!-- Header Section -->
    <div class="header-2d">
        Communicate Complex Science Simply With Our Services!
    </div>
    ...
    <h4>Environmental  Animations </h4>
    <p>
    ...
    <div class="col-md-6 mb-4">
    <h4>Physics and Engineering Animations</h4>
    <p>
    ...
    <img src="{{asset('images/scientific-animation/gif-4.gif')}}" alt="Illustration" class="illustration">
    </div>
    </div>
    </div>
