...
@section('title')
30 Seconds Video Maker - Create Impactful Animations
@endsection
...
@keyframes up-down {
 ...
 font-weight: 400;  
  ...
  <section id="hero" class="hero section dark-background">
    ...
    <div class="">
        <h1>30-Second Animated Video Company No More Boring Ads Now!</h1>
        <p>Your brand deserves more than static visuals. At AFX Animators, we craft custom 30-second videos that transform your message into a masterpiece in no time.</p>
...
<div class="container">
    <div class="row">
        <div class=" col-md-6 ">
            <h2>Boost Engagement & Drive Results With 30-Second Video Maker</h2>
<p style="font-size: 12px;">Welcome to AFX, the top choice for premium 30-second video creation. Our focus is on developing compelling videos that attract your audience’s interest and make a lasting impact. Utilizing our animation and storytelling skills, we give life to your concepts and assist in conveying your message efficiently within a short period.
   </p>
   <br>
    <p style="font-size: 12px;">At AFX, we recognize the impact of brief videos in today’s era of shorter attention spans. Our 30-second video company will work with you to create innovative ideas, write engaging scripts, and create visually captivating 30-second animated videos that reflect your brand identity and objectives.</p>
    <p style="font-size: 12px;">If you require an Animated Explainer Video, promotional video, or Whiteboard Animation Services, our committed team will collaborate with you during the production to bring your vision to life. We assure you that your target audience will remember your 30-second video due to our focus on detail, creativity, and technical skills.</p>
                <a href="{{route('contact')}}" class="btn-custom btn">Get in touch</a>
        </div>
        <div class="col-md-5 mt-4">
     <img src="{{asset('images/30-second/gif-1.gif')}}" alt="" srcset="" class="" style="padding-left:180px; height:300px; "  >
        </div>
    </div>
...
<section id="gallery" class="gallery section">
    ...
    <div class="container " data-aos="fade-up">
        <div class=" text-center">
            <h2 class=" card-title">Our Portfolio - Animation Excellence in Action</h2>
            <p>Uncover the impact of storytelling with our wide range of personalized 30-second video animation. Every project demonstrates our dedication to innovation, excellence, and client satisfaction. Check out our portfolio to see how AFX Animators can turn your ideas into reality.</p>
        </div>
...
<section style="background-color: #dedede; padding: 20px;">
    <div class="container" style="display: flex; align-items: center; justify-content: space-between;">
        <div>
            <span style="font-size: 1.5em; font-weight: bold;">Transform Your Brand in 30 Seconds</span>
...
<section style="background: linear-gradient(to bottom, #9e7469, #f3c1b4); color: rgb(22, 22, 22);">
...
<p style="font-size: 12px;">They provide a visually captivating method to simplify complex ideas, display products, and encourage customer engagement. Businesses can enhance their communication efficiency, improve conversions, and differentiate themselves in a competitive digital environment by summarizing important information in a user-friendly manner.</p>
            ...
            <div class=" col-md-6 ">
                <img src="{{asset('images/30-second/gif-2.gif')}}" alt="" srcset="" height="300" width="100%"  >
    ...
    <section style="background-color: #f9ce8a; color:black;">
    <div class="container ">
    <div class="row">
        <div class=" col-md-6 ">
            <img src="{{asset('images/30-second/gif-3.gif')}}" alt="" class="" height="400" width="100%">
        
            </div>
    <div class="col-md-6">
    <h3>What Sets AFX Animators Apart In 30 Second Videos?</h3>
    ...
    <a href="{{route('contact')}}" class="btn btn-custom">Get Started</a>
        ...
        <section style="background-color:#ffffff; color:black;" >
            <div class="container">
                <!-- Header Section -->
                <div class="header-2d">
                    Find Your Perfect 30-Second Video With Different Styles That We Offer
                </div>
            ...
            <h4>Promotional Videos</h4>
                    ...
                    <div class="col-md-4 text-center">
                        <img src="{{asset('images/30-second/img-1.png')}}" alt="Illustration" class="illustration">
                    </div>
                </div>
            </div>
