...
@keyframes up-down {
 ...
 font-weight: 400;  
  ...
  <section id="hero" class="hero section dark-background">
    ...
    <div class="">
        <h1>3D Character Modeling Company Forging Fantasies into Figures!</h1>
        <p>As a leading 3D model character maker, we specialize in delivering top-notch 3D character modeling services tailored to your unique needs.</p>
...
<div class="container">
    <div class="row">
        <div class=" col-md-6 ">
            <h2>3D Character Model Makers Delivering the Perfect 3D Character Model for Your Project!</h2>
<p style="font-size: 12px;">If you are a YouTuber, digital marketer, or small business that creates and publishes online videos, adding a video editor to your team is the most crucial addition you can make. You may have thought about employing a full-time editor (costly), attempted to oversee a freelancer (unreliable), or even edit your videos (exhausting). 
   ...
   <br>
    <p style="font-size: 12px;">Ultimately, none of these choices ever results in success. You make videos to increase your income, gain more freedom, and enjoy the process of making amazing content, not to exhaust yourself by working on your computer all day and eventually feeling overwhelmed. Increase your video production and quality by using our editing service for video, which will provide more value to your business than any other tool you have experienced. It might sound bold, but it’s true.</p>
     ...
     <img src="{{asset('images/3d-character-modeling/gif-1.gif')}}" alt="" srcset="" class="" style="padding-left:180px; height:300px; "  >
        </div>
    </div>
...
<section id="gallery" class="gallery section">
    ...
    <div class="container " data-aos="fade-up">
        <div class=" text-center">
            <h2 class=" card-title">Step Inside Our Gallery Of 3D Character Modeling</h2>
            <p>Our inventions transcend across industries and breathe life into stories, from animated film stars to gaming heroes. Explore our portfolio to see the outstanding craftsmanship and originality that characterize AFX Animators.</p>
        </div>
...
<section style="background-color: #dedede; padding: 20px;">
    <div class="container" style="display: flex; align-items: center; justify-content: space-between;">
        <div>
            <span style="font-size: 1.5em; font-weight: bold;">See the Magic of 3D Character Modeling</span>
...
<section style="background-color:#87d1ff; color:rgb(2, 2, 2);">
    <div class="container">
        <div class="row">
            ...
            <div class="col-md-6">
                <h1>Importance Of 3D Character Modeling Services</h1>
...
<p style="font-size: 12px;">Furthermore, character animation creators can customize animations to match a business’s brand image, guaranteeing uniformity on all channels. This not only sets the business apart from competitors but also fosters a deeper relationship with the target audience, ultimately leading to increased conversion rates and customer loyalty.</p>
            ...
            <div class=" col-md-6 ">
                <img src="{{asset('images/3d-character-modeling/gif-2.gif')}}" alt="" srcset="" height="300" width="100%"  >
    ...
    <div class="row">
        <div class=" col-md-6 ">
            <img src="{{asset('images/3d-character-modeling/gif-3.gif')}}" alt="" class="" height="400" width="100%">
    ...
    <a href="{{route('contact')}}" class="btn btn-custom">Get Started</a>
        ...
        <section style="background-color:#4d4d4d; color:black;" >
            <div class="container">
                <!-- Header Section -->
                <div class="header-2d">
            ...
            <h4>3D Character Animation </h4>
                    ...
                    <div class="col-md-4 text-center">
                        <img src="{{asset('images/3d-character-modeling/gif-6.gif')}}" alt="Illustration" class="illustration">
                    </div>
                </div>
            </div>
