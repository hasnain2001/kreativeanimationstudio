...
@keyframes up-down {
 ...
 font-weight: 400;  
  ...
  <section id="hero" class="hero section dark-background">
    ...
    <div class="">
        <h1>3D Modeling And Sculpting Studio  Leading the Way In 3D Art Masterpieces!</h1>
        <p>Raise the bar for your animation projects with stunning 3D sculpted models and objects brought to life by AFX Animators’ expert sculpting team.</p>
...
<div class="container">
    <div class="row">
        <div class=" col-md-6 ">
            <h2>AFX 3D Digital Sculpting Showcasing The Art of Digital Clay</h2>
<p style="font-size: 12px;">AFX Animators is known for providing high-quality 3D sculpting services to its worldwide clients with the help of a skilled team of 3D sculptors who can execute complex digital sculpting for optimal outcomes. We are a well-known provider of 3D modeling sculpting services, able to artistically shape and control virtual objects while adhering to technical specifications. Like sculpting clay, we can enhance digital 3D sculpt models by incorporating meshes and textures. We utilize hand-drawn sketches, photos, ideas, concept papers, or reference objects to represent our clients’ vision.
   </p>
   <br>
    <p style="font-size: 12px;">At AFX, our team has demonstrated skill in adding precise detailing to the meshes to create flawless digital sculptures. Because traditional modeling doesn’t produce excellent results, we can use 3D Animation Services or combine both methods to meet the clients’ expectations. With the assistance of our sculpt modeling services, we offer top-notch solutions for various industries’ sculpting requirements by creating stylized models.</p>
                <a href="{{route('contact')}}" class="btn-custom btn">Get in touch</a>
        </div>
        <div class="col-md-5 mt-4">
     <img src="{{asset('images/sculping/gif-1.gif')}}" alt="" srcset="" class="" style="padding-left:180px; height:300px; "  >
        </div>
    </div>
...
<section id="gallery" class="gallery section">
    ...
    <div class="container " data-aos="fade-up">
        <div class=" text-center">
            <h2 class=" card-title">Explore Our Work of Bringing Ideas to Life!</h2>
            <p>Discover our wide range of projects demonstrating outstanding 3D sculpting work we’ve done for clients in different industries. Every model showcases our dedication to excellence, innovation, and attention to detail.</p>
        </div>
...
<section style="background-color: #dedede; padding: 20px;">
    <div class="container" style="display: flex; align-items: center; justify-content: space-between;">
        <div>
            <span style="font-size: 1.5em; font-weight: bold;">Your Dream Model Awaits</span>
            <p>Start Your Custom 3D Sculpting Project Today!</p>
        </div>
        <a href="{{route('contact')}}" class="btn btn-custom" style="margin-left: 20px;">Chat With Us</a>
    </div>
</section>

<section style="background: linear-gradient(to bottom, #050a13, #1d3e5b); color: rgb(252, 247, 247);">
    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-md-6">
                <h1>Why Is 3D Character Sculpting Important?</h1>
<p  style="font-size: 12px;">Sculpting 3D characters is essential as it transforms creativity into reality, producing lifelike, emotive, and lively characters that boost the visual narrative of a project. This method enables intricate customization and detailing, enhancing character engagement and relatability. Top-notch character design services guarantee that characters look attractive and faithfully depict the desired design, which is crucial for animation, gaming, virtual reality, and film sectors. </p>

<p style="font-size: 12px;">Additionally, it enhances visualization and iteration in the development process, ultimately fostering creativity and innovation. In the end, creating 3D characters through sculpting enhances the overall quality and impact of a digital project.</p>
                    <a href="{{route('contact')}}" class="btn btn-custom">Get Started</a>
            </div>
            <div class=" col-md-6 ">
                <img src="{{asset('images/sculping/gif-2.gif')}}" alt="" srcset="" height="300" width="100%"  >
    ...
    <section style="background-color: #314153; color:white;">
    <div class="container ">
    <div class="row">
        <div class=" col-md-6 ">
            <img src="{{asset('images/sculping/gif-3.gif')}}" alt="" class="" height="400" width="100%">
        
            </div>
    <div class="col-md-6">
    <h3>Why Choose AFX Animators for 3D Sculpting?</h3>
    ...
    <a href="{{route('contact')}}" class="btn btn-custom">Get Started</a>
        ...
        <section style="background-color:#ffffff; color:black;" >
            <div class="container">
                <!-- Header Section -->
                <div class="header-2d">
                    Dive into Our 3D Sculpting Services!
                </div>
            ...
            <h4>Environmental Modeling</h4>
                    ...
                    <div class="col-md-4 text-center">
                        <img src="{{asset('images/sculping/img-1.png')}}" alt="Illustration" class="illustration">
                    </div>
                </div>
            </div>
