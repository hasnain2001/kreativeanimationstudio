...
@section('title')
60-Second Animated Videos Services - Captivate in One Minute
@endsection
...
@keyframes up-down {
 ...
 font-weight: 400;  
  ...
  .header-2d {
    ...
    .section-1{
    background-color:#ee5564; /* Fallback color */
  ...
  <section id="hero" class="hero section dark-background">
    ...
    <div class="">
        <h1>60-Second Video Maker Company  Getting You Noticed Instantly!</h1>
        <p>Your brand deserves more than static visuals. At AFX Animators, we craft custom 60-seconds videos that transform your message into a masterpiece in no time.</p>
...
<div class="container">
    <div class="row">
        <div class=" col-md-6 ">
            <h2>Boost Engagement & Drive Results With 60-secondsVideo Maker</h2>
<p style="font-size: 12px;">Welcome to AFX, the top choice for premium 60-secondsvideo creation. Our focus is on developing compelling videos that attract your audience’s interest and make a lasting impact. Utilizing our animation and storytelling skills, we give life to your concepts and assist in conveying your message efficiently within a short period.
   </p>
   <br>
    <p style="font-size: 12px;">At AFX, we recognize the impact of brief videos in today’s era of shorter attention spans. Our 60-secondsvideo company will work with you to create innovative ideas, write engaging scripts, and create visually captivating 60-secondsanimated videos that reflect your brand identity and objectives.</p>
    <p style="font-size: 12px;">If you require an Animated Explainer Video, promotional video, or Whiteboard Animation Services, our committed team will collaborate with you during the production to bring your vision to life. We assure you that your target audience will remember your 60-secondsvideo due to our focus on detail, creativity, and technical skills.</p>
     ...
     <img src="{{asset('images/60-second/gif-1.gif')}}" alt="" srcset="" class="" style="padding-left:180px; height:300px; "  >
        </div>
    </div>
...
<section id="gallery" class="gallery section">
    ...
    <div class="container " data-aos="fade-up">
        <div class=" text-center">
            ...
            <p>Uncover the impact of storytelling with our wide range of personalized 60-secondsvideo animation. Every project demonstrates our dedication to innovation, excellence, and client satisfaction. Check out our portfolio to see how AFX Animators can turn your ideas into reality.</p>
        </div>
...
<section style="background: linear-gradient(to bottom, #664a93, #8d6bc4); color: rgb(255, 255, 255);">
    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-md-6">
                <h1>Why Do Businesses Require 60 Second Explainer Videos?</h1>
...
<p style="font-size: 12px;">They provide a visually captivating method to simplify complex ideas, display products, and encourage customer engagement. Businesses can enhance their communication efficiency, improve conversions, and differentiate themselves in a competitive digital environment by summarizing important information in a user-friendly manner.</p>
            ...
            <div class=" col-md-6 ">
                <img src="{{asset('images/60-second/gif-2.gif')}}" alt="" srcset="" height="300" width="100%"  >
    ...
    <div class="row">
        <div class=" col-md-6 ">
            <img src="{{asset('images/60-second/gif-3.gif')}}" alt="" class="" height="400" width="100%">
    ...
    <a href="{{route('contact')}}" class="btn btn-custom">Get Started</a>
        ...
        <section style="background-color:#ffffff; color:black;" >
            <div class="container">
                <!-- Header Section -->
                <div class="header-2d">
                    Find Your Perfect 60-seconds Video With Different Styles That We Offer
                </div>
            ...
            <h4>Brand Introductions</h4>
                    ...
                    <div class="col-md-4 text-center">
                        <img src="{{asset('images/60-second/img-1.png')}}" alt="Illustration" class="illustration">
                    </div>
                </div>
            </div>
