...
@section('title')
90-Second Video Explainers - Transforming Your Message
@endsection
@section('description')
AFX Animators specializes in creating captivating 90-second video explainers. We offer high-quality animations designed to engage your audience.
@endsection
...
@keyframes up-down {
 ...
 font-weight: 400;  
  ...
  .header-2d {
    ...
    .section-1{
    background-color:#93a5fe; /* Fallback color */
    color:rgb(0, 0, 0);
  ...
  <section id="hero" class="hero section dark-background">
    ...
    <div class="">
<h1>90 Seconds Video Company Crafting Visual Magic in Every Frame!</h1>
<p>At AFX Animators, we specialize in creating dynamic and engaging 90 second explainer videos that captivate audiences and drive results.</p>
...
<div class="container">
    <div class="row">
        <div class=" col-md-6 ">
            <h2>90 Seconds Video Agency - Crafting Powerful Animations That Convert
            </h2>
<p style="font-size: 14px;">Welcome to AFX, the top choice for premium 60-secondsvideo creation. Our focus is on developing compelling videos that attract your audience’s interest and make a lasting impact. Utilizing our animation and storytelling skills, we give life to your concepts and assist in conveying your message efficiently within a short period.
    ...
    <p style="font-size: 14px;">If you require an Animated Explainer Video, promotional video, or Whiteboard Animation Services, our committed team will collaborate with you during the production to bring your vision to life. We assure you that your target audience will remember your 60-secondsvideo due to our focus on detail, creativity, and technical skills.</p>
     ...
     <img src="{{asset('images/90-second/gif-1.gif')}}" alt="" srcset="" class="" style="padding-left:180px; height:300px; "  >
        </div>
    </div>
...
<section id="gallery" class="gallery section">
    ...
    <div class="container " data-aos="fade-up">
        <div class=" text-center">
            <h2 class=" card-title">Explore Our Portfolio & Creative Masterpieces</h2>
            <p>Explore the amazing 90-second videos created by our 90 seconds video agency. Our portfolio features a wide variety of original animations created with the intention of captivating and involving viewers. View our process for bringing concepts to life through eye-catching imagery and gripping narration.</p>
        </div>
...
<section style="background-color: #dedede; padding: 20px;">
    <div class="container" style="display: flex; align-items: center; justify-content: space-between;">
        <div>
            <span style="font-size: 1.5em; font-weight: bold;">Don't Miss Out!</span>
            <p>Boost Engagement Instantly.</p>
        </div>
...
<section style="background: linear-gradient(to bottom, #e3dbf1, #ffffff); color: rgb(0, 0, 0);">
    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-md-6">
                <h1>Why Do Businesses Need 90 Second Explainer Videos?</h1>
...
<p style="font-size: 12px;">They provide a visually captivating method to simplify complex ideas, display products, and encourage customer engagement. Businesses can enhance their communication efficiency, improve conversions, and differentiate themselves in a competitive digital environment by summarizing important information in a user-friendly manner.</p>
            ...
            <div class=" col-md-6 ">
                <img src="{{asset('images/90-second/img-1.png')}}" alt="" srcset="" height="300" width="100%"  >
    ...
    <section style="background-color:#c2515d; color:black;">
    <div class="container ">
    <div class="row">
        <div class=" col-md-6 ">
            <img src="{{asset('images/90-second/gif-2.gif')}}" alt="" class="" height="400" width="100%">
        
            </div>
    <div class="col-md-6">
    <h3>Why Choose AFX Animators for Your 90 Second Video?</h3>
    ...
    <a href="{{route('contact')}}" class="btn btn-custom">Get Started</a>
        ...
        <section style="background-color:#ffffff; color:black;" >
            <div class="container">
                <!-- Header Section -->
                <div class="header-2d">
                    Engage, Explain, Excite With Our Range Of 90-Second Videos
                </div>
            ...
            <h4>Promotional Videos</h4>
                    ...
                    <div class="col-md-4 text-center">
                        <img src="{{asset('images/90-second/gif-3.gif')}}" alt="Illustration" class="illustration">
                    </div>
                </div>
            </div>
