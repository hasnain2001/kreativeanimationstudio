...
<div class="container">
    <div class="row">
        <div class=" col-md-6 ">
            <h2>Concept Art Agency Transforming Ideas into Polished Visuals</h2>
<p style="font-size: 14px;">Welcome to AFX, the top choice for premium 60-secondsvideo creation. Our focus is on developing compelling videos that attract your audience’s interest and make a lasting impact. Utilizing our animation and storytelling skills, we give life to your concepts and assist in conveying your message efficiently within a short period.
    ...
    <p style="font-size: 14px;">If you require an Animated Explainer Video, promotional video, or Whiteboard Animation Services, our committed team will collaborate with you during the production to bring your vision to life. We assure you that your target audience will remember your 60-secondsvideo due to our focus on detail, creativity, and technical skills.</p>
     ...
     <img src="{{asset('images/concept-art/gif-1.gif')}}" alt="image" srcset="" class=" img-fluid"  >
        </div>
    </div>
...
<section id="gallery" class="gallery section">
    ...
    <div class="container " data-aos="fade-up">
        <div class=" text-center">
            <h2 class=" card-title">Explore Our Portfolio - A Canvas of Imagination</h2>
            <p>See how our experienced rotoscoping skills have brought animations to life, giving projects a smooth, lifelike motion. View our work to see why leading companies and creators choose AFX Animators for their rotoscoping needs.</p>
        </div>
...
<section style="background-color: #dedede; padding: 20px;">
    <div class="container" style="display: flex; align-items: center; justify-content: space-between;">
        <div>
            ...
            <p>Get a Free Concept Art Quote Now!</p>
        </div>
...
<section style="background: linear-gradient(to bottom,#dadada, #ffffff); color: rgb(0, 0, 0);">
    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-md-6">
                <h1>How Does A Concept Art Design Studio Help Your Business?</h1>
...
<p style="font-size: 12px;">They provide a visually captivating method to simplify complex ideas, display products, and encourage customer engagement. Businesses can enhance their communication efficiency, improve conversions, and differentiate themselves in a competitive digital environment by summarizing important information in a user-friendly manner.</p>
            ...
            <div class=" col-md-6 ">
                <img src="{{asset('images/concept-art/img-1.png')}}" alt="" srcset="" height="300" width="100%"  >
    ...
    <section style="background-color:#26353d; color:rgb(255, 255, 255);">
    <div class="container ">
    <div class="row">
        <div class=" col-md-6 ">
            <img src="{{asset('images/concept-art/gif-3.gif')}}" alt="" class="" height="400" width="100%">
        
            </div>
    <div class="col-md-6">
    <h3>Why Choose AFX Animators For Concept Art Services?</h3>
    ...
    <a href="{{route('contact')}}" class="btn btn-custom">Get Started</a>
        ...
        <section style="background-color:#484855; color:rgb(255, 255, 255);" >
    <div class="container">
    <!-- Header Section -->
    <div class="header-2d">
        Get Inspired With Our Concept Art Services!
    </div>
    ...
    <div class="col-md-6 mb-4">
    <h4>Visual Effects Integration</h4>
    <p>
    ...
    <img src="{{asset('images/concept-art/gif-2.gif')}}" alt="Illustration" class="illustration">
    </div>
    </div>
    </div>
