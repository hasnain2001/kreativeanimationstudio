...
@section('title')
Frame By Frame  Animator Services - From Vision to Visuals
@endsection
...
@keyframes up-down {
 ...
 font-weight: 400;  
  ...
  <section id="hero" class="hero section dark-background">
    ...
    <div class="">
        <h1>Animated Frame By Frame s Company Turning Concepts into Art!</h1>
        <p>Tired of flat, static visuals?  AFX Animators is a leading animated Frame By Frame  company, that transforms concepts into captivating, dynamic narratives that grab attention and propel your story forward.</p>
...
<div class="container">
    <div class="row">
        <div class=" col-md-6 ">
            <h2>Trusted Frame By Frame Animation Maker in the USA</h2>
<p style="font-size: 12px;">AFX Animators, your leading promotional video agency, creates creative animated promotional videos that bring your idea to life, whether it’s an animated explainer video, product demo, or brand story. We recognize that each brand has a unique story to tell, and our professionals create unique narratives that connect with your target audience, increasing engagement and conversion. 
   ...
   <br>
    <p style="font-size: 12px;">We prioritize quality in our promotional video creation services, employing cutting-edge animation techniques and tools to create visually stunning videos that leave a lasting impact. From concept to final delivery, AFX Animators oversees the entire production process, assuring a smooth experience and a polished result. AFX Animators offers amazing, customized promotional video production services that will set you apart.</p>
        ...
        <div class="col-md-6">
     <img src="{{asset('images/frame-by-frame/gif-1.gif')}}" alt="" srcset="" class="" height="300px" width="100%" >
        </div>
    </div>
...
<section id="gallery" class="gallery section">
    ...
    <div class="container " data-aos="fade-up">
        <div class=" text-center">
            <h2 class=" card-title"> See Our Frame By Frame  Animation Work in Action</h2>
...
<section style="background-color: #dedede; padding: 20px;">
    <div class="container" style="display: flex; align-items: center; justify-content: space-between;">
        <div>
            <span style="font-size: 1.5em; font-weight: bold;">Level Up Your Visuals</span>
            <p>Unlock the Power of Frame By Frame  Animation!</p>
        </div>
        <a href="{{route('contact')}}" class="btn btn-custom" style="margin-left: 20px;">Chat With Us</a>
    </div>
</section>

<section style="background-color:#f6fafa; color:rgb(2, 2, 2);">
    <div class="container">
        <div class="row">
            <div class=" col-md-6 ">
                <img src="{{asset('images/frame-by-frame/img-1.png')}}" alt="" srcset="" height="300" width="100%"  >
             
            </div>
            <div class="col-md-6">
                <h1>Why Do Businesses Need Frame By Frame  Animation Experts?</h1>
...
<p style="font-size: 12px;">By utilizing the skills of a motion graphics video maker, companies can ensure that their message gets noticed in the crowd, connects with their target audience, and leads to desired outcomes like brand recognition, interaction, and sales. Furthermore, the motion graphics animation service provides innovation and technical expertise that may not be present internally, enabling companies to obtain top-notch content that enhances their brand image and distinguishes them from the competition.</p>
    ...
    <div class="col-md-6">
    <h3>The Frame By Frame  Animation Edge - Why Choose AFX Animators?</h3>
    ...
    <div class=" col-md-6 ">
    <img src="{{asset('images/frame-by-frame/gif-2.gif')}}" alt="" class="img-fluid">
        ...
        <section style="background-color: #f7d700; color:black;" >
            <div class="container">
                <!-- Header Section -->
                <div class="header-2d">
                    Engagement Is Guaranteed With Our Frame By Frame  Animation Services!
                </div>
            ...
            <h4>Visual Frame By Frame ing </h4>
                            ...
                            <div class="col-md-6 mb-4">
                                ...
                                <p>
                                    We at AFX recognize the power of images in communicating a story. Our hand-drawn graphics and animations are utilized in our Frame By Frame  Animation Services to help explain difficult ideas and increase the reliability of your material.
                                </p>
                            </div>
                            <div class="col-md-6 mb-4">
                    ...
                    <div class="col-md-4 text-center">
                        <img src="{{asset('images/frame-by-frame/gif-3.gif')}}" alt="Illustration" class="illustration">
                    </div>
                </div>
            </div>
