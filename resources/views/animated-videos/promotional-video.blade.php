...
@section('title')
Promotional Video Making Service - Creating Engaging Videos
@endsection
...
@keyframes up-down {
 ...
 font-weight: 400;  
  ...
  .header-2d {
            background-color:;
            background: linear-gradient(90deg, #27c0c0, #20a7a7); /* Gradient background */
            color: white;
    text-align: center;
...
<p style="font-size: 14px;">AFX Animators, your leading promotional video agency, creates creative animated promotional videos that bring your idea to life, whether it’s an animated explainer video, product demo, or brand story. We recognize that each brand has a unique story to tell, and our professionals create unique narratives that connect with your target audience, increasing engagement and conversion. 
   ...
   <br>
    <p style="font-size: 14px;">We prioritize quality in our promotional video creation services, employing cutting-edge animation techniques and tools to create visually stunning videos that leave a lasting impact. From concept to final delivery, AFX Animators oversees the entire production process, assuring a smooth experience and a polished result. AFX Animators offers amazing, customized promotional video production services that will set you apart.</p>
        ...
        <div class="col-md-6">
     <img src="{{asset('images/promotional-video/img-1.png')}}" alt="" srcset="" class="" height="300px" width="100%" >
        </div>
    </div>
...
<section style="background-color:#69b9b4; color:white;">
    <div class="container">
        <div class="row">
            ...
            <div class="col-md-6">
                <h1>Why Do Businesses Need Professional Promotional Video Maker?</h1>
...
<p style="font-size: 12px;">By utilizing the skills of a motion graphics video maker, companies can ensure that their message gets noticed in the crowd, connects with their target audience, and leads to desired outcomes like brand recognition, interaction, and sales. Furthermore, the motion graphics animation service provides innovation and technical expertise that may not be present internally, enabling companies to obtain top-notch content that enhances their brand image and distinguishes them from the competition.</p>
            ...
            <div class=" col-md-6 ">
                <img src="{{asset('images/promotional-video/gif-1.gif')}}" alt="" srcset="" height="300" width="100%"  >
    ...
    <div class="col-md-6">
    <h3>Wondering What Makes AFX Animators Exceptional?</h3>
    ...
    <div class=" col-md-6 ">
    <img src="{{asset('images/promotional-video/gif-2.gif')}}" alt="" class="img-fluid">
            ...
            <div class="container">
                ...
                <div class="row section-content">
                    ...
                    <div class="col-md-4 text-center">
                        <img src="{{asset('images/promotional-video/gif-3.gif')}}" alt="Illustration" class="illustration">
                    </div>
                </div>
            </div>
