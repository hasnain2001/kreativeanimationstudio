...
@section('title')
Storyboard Animator Services - From Vision to Visuals
@endsection
...
@keyframes up-down {
 ...
 font-weight: 400;  
  ...
  <section id="hero" class="hero section dark-background">
    ...
    <div class="">
        <h1>Animated Storyboards Company Turning Concepts into Art!</h1>
        <p>Tired of flat, static visuals?  AFX Animators is a leading animated storyboard company, that transforms concepts into captivating, dynamic narratives that grab attention and propel your story forward.</p>
...
<div class="container">
    <div class="row">
        <div class=" col-md-6 ">
            <h1>Start Your Visual Storytelling Journey With Our Storyboard Animation Studio</h1>
<p style="font-size: 12px;">AFX Animators, your leading promotional video agency, creates creative animated promotional videos that bring your idea to life, whether it’s an animated explainer video, product demo, or brand story. We recognize that each brand has a unique story to tell, and our professionals create unique narratives that connect with your target audience, increasing engagement and conversion. 
   ...
   <br>
    <p style="font-size: 12px;">We prioritize quality in our promotional video creation services, employing cutting-edge animation techniques and tools to create visually stunning videos that leave a lasting impact. From concept to final delivery, AFX Animators oversees the entire production process, assuring a smooth experience and a polished result. AFX Animators offers amazing, customized promotional video production services that will set you apart.</p>
        ...
        <div class="col-md-6">
     <img src="{{asset('images/storyboard/gif-1.gif')}}" alt="" srcset="" class="" height="300px" width="100%" >
        </div>
    </div>
...
<section id="gallery" class="gallery section">
    ...
    <div class="container " data-aos="fade-up">
        <div class=" text-center">
            <h2 class=" card-title"> See Our storyboard Animation Work in Action</h2>
...
<section style="background-color: #dedede; padding: 20px;">
    <div class="container" style="display: flex; align-items: center; justify-content: space-between;">
        <div>
            ...
            <p>Unlock the Power of Storyboard Animation!</p>
        </div>
...
<section style="background-color:#69b9b4; color:white;">
    <div class="container">
        <div class="row">
            <div class=" col-md-6 ">
                <img src="{{asset('images/storyboard/img-1.png')}}" alt="" srcset="" height="300" width="100%"  >
             
            </div>
            <div class="col-md-6">
                <h1>Why Do Businesses Need storyboard Animation Experts?</h1>
...
<p style="font-size: 12px;">By utilizing the skills of a motion graphics video maker, companies can ensure that their message gets noticed in the crowd, connects with their target audience, and leads to desired outcomes like brand recognition, interaction, and sales. Furthermore, the motion graphics animation service provides innovation and technical expertise that may not be present internally, enabling companies to obtain top-notch content that enhances their brand image and distinguishes them from the competition.</p>
    ...
    <div class="col-md-6">
    <h3>The storyboard Animation Edge - Why Choose AFX Animators?</h3>
    ...
    <div class=" col-md-6 ">
    <img src="{{asset('images/storyboard/gif-2.gif')}}" alt="" class="img-fluid">
        ...
        <section >
            <div class="container">
                <!-- Header Section -->
                <div class="header-2d">
                    Engagement Is Guaranteed With Our storyboard Animation Services!
                </div>
            ...
            <h4>Visual Storyboarding </h4>
                            ...
                            <div class="col-md-6 mb-4">
                                ...
                                <p>
                                    We at AFX recognize the power of images in communicating a story. Our hand-drawn graphics and animations are utilized in our storyboard Animation Services to help explain difficult ideas and increase the reliability of your material.
                                </p>
                            </div>
                            <div class="col-md-6 mb-4">
                    ...
                    <div class="col-md-4 text-center">
                        <img src="{{asset('images/storyboard/gif-3.gif')}}" alt="Illustration" class="illustration">
                    </div>
                </div>
            </div>
