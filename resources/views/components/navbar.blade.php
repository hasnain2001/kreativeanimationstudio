...
<ul class="dropdown-menu text-capitalize" aria-labelledby="navbarDropdown">
<li><a class="dropdown-item {{ request()->is('insight') ? 'active' : '' }}" href="{{route('insight')}}"> game art</a></li>
<li><hr class="dropdown-divider"></li>
<li><a class="dropdown-item {{ request()->is('our-process') ? 'active' : '' }}" href="{{route('our-process')}}">ed animation</a></li>
<li><hr class="dropdown-divider"></li>
