...
@section('title')
Game Animation Services - Level Up Your Game!
@endsection
@section('description')
...
@keyframes up-down {
 ...
 font-weight: 400;  
  ...
  .header-2d {
    ...
    .section-1{
    background-color:#4e3b56; /* Fallback color */
  ...
  <section id="hero" class="hero section dark-background">
    ...
    <div class=" col-md-5">
<h1>Game Animation Company Transforming Your Gameplay! </h1>
<p>We’re passionate about crafting custom video game animation where every frame counts to immerse players in your world.</p>
...
<div class="container">
    <div class="row">
        <div class=" col-md-6 ">
<h2>Our Game Animation Makers Produce Visually Impressive Animations!</h2>
<p style="font-size: 14px;">Welcome to AFX, the top choice for premium 60-secondsvideo creation. Our focus is on developing compelling videos that attract your audience’s interest and make a lasting impact. Utilizing our animation and storytelling skills, we give life to your concepts and assist in conveying your message efficiently within a short period.
    ...
    <p style="font-size: 14px;">If you require an Animated Explainer Video, promotional video, or Whiteboard Animation Services, our committed team will collaborate with you during the production to bring your vision to life. We assure you that your target audience will remember your 60-secondsvideo due to our focus on detail, creativity, and technical skills.</p>
     ...
     <img src="{{asset('images/game-animation/gif-1.gif')}}" alt="image" srcset="" class=" rounded img-fluid"  >
        </div>
    </div>
...
<section id="gallery" class="gallery section">
    ...
    <h2 class=" card-title">Witness the Power of Our Game Animation</h2>
    <p>AFX Animators’ work showcases their dedication to excellence and innovation by creating captivating visuals and immersive experiences in mobile games, indie hits, and blockbuster titles.</p>
    </div>
...
<section style="background-color: #dedede; padding: 20px;">
    <div class="container" style="display: flex; align-items: center; justify-content: space-between;">
        <div>
            <span style="font-size: 1.5em; font-weight: bold;">Your Game Deserves the Best</span>
            <p>Get Started with AFX Animators!</p>
        </div>
...
<section style="background: linear-gradient(to bottom,#c1a3ff, #c1a3ff); color: rgb(0, 0, 0);">
    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-md-6">
                <h1>Why Should You Hire A Game Animation Studio?</h1>
...
<p style="font-size: 12px;">They provide a visually captivating method to simplify complex ideas, display products, and encourage customer engagement. Businesses can enhance their communication efficiency, improve conversions, and differentiate themselves in a competitive digital environment by summarizing important information in a user-friendly manner.</p>
            ...
            <div class=" col-md-6 ">
                <img src="{{asset('images/game-animation/gif-2.gif')}}" alt="" srcset="" class="rounded" height="300" width="100%"  >
    ...
    <div class="row">
        <div class=" col-md-6 ">
            <img src="{{asset('images/game-animation/gif-3.gif')}}" alt="" class=" rounded" height="400" width="100%">
        
            </div>
    <div class="col-md-6">
    <h3>Why Choose AFX Animators for Game Animation Services?</h3>
    ...
    <div class="container">
    <!-- Header Section -->
    <div class="header-2d">Our Stunning Game Animation Services</div>
    ...
    <img src="{{asset('images/game-animation/gif-4.gif')}}" alt="Illustration" class=" rounded illustration">
    </div>
    </div>
    </div>
